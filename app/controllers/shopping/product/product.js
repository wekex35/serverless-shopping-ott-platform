...
const Product = require('../../../models/shopping/productModel');
const categoryModel = require('../../../models/shopping/categoryModel');
...
product.getShoppingHomeScreen = async (callback, event) => {
    try {
