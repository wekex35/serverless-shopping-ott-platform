...
const TableName = "MusicPaymentTable";
const Uuid = require('uuid')
const documentClient = new AWS.DynamoDB.DocumentClient();
const Product = require('./musicModel');
const transactionModel = require('../transactionModel');

const getMusicPaymentInfoById = async (trans_id) => {
    if (!trans_id) throw { message: 'Please provide PlaceMusicPayment Id' };
    var params = {
        TableName,
        Key: {
            trans_id
...
const deleteMusicPayment = async (product_id, user_id) => {
...
/* 
const placeMusicPayment = async (data) => {
    // data.payment_id
...
const updateMusicPaymentStatus = async (data) => {
    console.log(data);
...
const getMusicPaymentHistory = async (user_id) => {
    const params = {
        TableName,
...
module.exports = {
    getMusicPaymentInfoById,
    deleteMusicPayment,
    // placeMusicPayment,
    orderExits,
    updateMusicPaymentStatus,
    setActive,
    getMusicPaymentHistory
};