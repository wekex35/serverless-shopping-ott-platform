...
const TableName = "VideoPaymentTable";
const Uuid = require('uuid')
const documentClient = new AWS.DynamoDB.DocumentClient();
const Product = require('./videoModel');
const transactionModel = require('../transactionModel');

const getVideoPaymentInfoById = async (trans_id) => {
    if (!trans_id) throw { message: 'Please provide PlaceVideoPayment Id' };
    var params = {
        TableName,
        Key: {
            trans_id
...
const deleteVideoPayment = async (product_id, user_id) => {
...
// const placeVideoPayment = async (data) => {
//     // data.payment_id
...
const updateVideoPaymentStatus = async (data) => {
    console.log(data);
...
const getVideoPaymentHistory = async (user_id) => {
    const params = {
        TableName,
...
module.exports = {
    getVideoPaymentInfoById,
    deleteVideoPayment,
    // placeVideoPayment,
    orderExits,
    updateVideoPaymentStatus,
    setActive,
    getVideoPaymentHistory
};