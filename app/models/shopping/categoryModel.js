...
const getCategoryById = async (trans_id) => {
    if (!trans_id) throw { message: 'Please provide Category Id' };
    var params = {
        TableName,
        Key: {
            trans_id
...
const deleteCategory = async (category_id,client_id) => {
    if (!category_id) throw { message: 'Please provide Category Id' };
...
const getAllCategory = async (client_id) => {
...
const getAllSubCategory = async (client_id,category_id) => {
